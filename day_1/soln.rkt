...
(define/contract (solve-a filename)
  ...
  (define-values (AS BS) (read-loclists filename)) ; unsorted, in reverse order
...
(define/contract (read-loclists filename)
  (-> string? (values (listof exact-integer?) (listof exact-integer?)))
